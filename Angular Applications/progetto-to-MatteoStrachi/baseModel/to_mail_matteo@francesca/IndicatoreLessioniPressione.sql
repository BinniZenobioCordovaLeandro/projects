  ...
  select count(distinct(id_person)) as "persone con lesione"
   ...
   where id_contract in
     	 (
     	   select id
           from contracts c
          where ((valid_from between '12-12-2017' and '10-10-2018')
             or (valid_from <= '12-12-2017'
            and (valid_to is null or NULLIF(valid_to, '10-10-2018')
        between '12-12-2017' and '10-10-2018')))
...
-- "persone presenti"
  select count(*) as "persone presenti"
    ...
    where p.fl_patient = true
      ...
      and (c.valid_from between '12-12-2017' and '10-10-2018')
       or (c.valid_from <= '12-12-2017'
      and (c.valid_to is null or NULLIF(c.valid_to, '10-10-2018') between '12-12-2017' and '10-10-2018'))

-- "persone con lesione al primo stadio"
...
-- "persone con lesione al secondo stadio"
...
-- "persone con lesione al terzo stadio"
...
-- "persone con lesione al quarto stadio"
...
-- "persone a RSA con almeno 1 lesione (i)"
   ...
   where id_contract in
     	 (
      		  ...
      		  where id_service in
      		    ...
      		    and ((valid_from between '12-12-2017' and '10-10-2018')
               or (valid_from <= '12-12-2017'
              and (valid_to is null or NULLIF(valid_to, '10-10-2018')
          between '12-12-2017' and '10-10-2018')))
              and id = f.id_contract
     ...
     and id_contract not in
       (
         select id
           from contracts c
          where valid_from between '10/10/2018' and '30/11/2018'
            and id_contractee in
          	  (
          	    select id
          	      from subjects_cr
...
-- "nuovi ingressi nel periodo di riferimento"
...
-- "persone con lesione, malnutrite, intervento nutrizionale (energetica - proteica)"
1 as "persone con lesione, malnutrite, intervento nutrizionale (energetica - proteica)",

-- "persone con lesione da pressione e malnutriti"
